...
function seedData() {
  ...
  DB.set('patients', [
    { id: 1, name: 'Maria Santos', dob: '1985-03-15', gender: 'Female', blood: 'O+', phone: '09171234567', address: 'Quezon City, Metro Manila', history: 'Hypertension, Penicillin allergy', status: 'Active', emergency: 'Jose Santos – 09171234568' },
    { id: 2, name: 'Juan dela Cruz', dob: '1990-07-22', gender: 'Male', blood: 'A+', phone: '09281234567', address: 'Makati City, Metro Manila', history: 'None', status: 'Active', emergency: 'Ana dela Cruz – 09281234568' },
    { id: 3, name: 'Ana Reyes', dob: '1978-11-08', gender: 'Female', blood: 'B+', phone: '09451234567', address: 'Pasig City, Metro Manila', history: 'Type 2 Diabetes', status: 'Critical', emergency: 'Carlos Reyes – 09451234568' },
    { id: 4, name: 'Pedro Garcia', dob: '1965-05-30', gender: 'Male', blood: 'AB+', phone: '09561234567', address: 'Taguig City, Metro Manila', history: 'Asthma', status: 'Active', emergency: 'Luz Garcia – 09561234568' },
  ]);

  DB.set('doctors', [
    { id: 1, name: 'Dr. Liza Reyes', spec: 'Cardiology', phone: '09171112222', email: 'lreyes@hospital.com', license: 'PRC-12345', schedule: 'Mon-Fri (Morning)', status: 'Active' },
    { id: 2, name: 'Dr. Ramon Santos', spec: 'General Medicine', phone: '09282223333', email: 'rsantos@hospital.com', license: 'PRC-23456', schedule: 'Mon-Fri (Afternoon)', status: 'Active' },
    { id: 3, name: 'Dr. Cora Villanueva', spec: 'Pediatrics', phone: '09453334444', email: 'cvillanueva@hospital.com', license: 'PRC-34567', schedule: 'Tue-Sat', status: 'Active' },
  ]);

  const today = new Date().toISOString().split('T')[0];
  DB.set('appointments', [
    { id: 1, patient: 'Maria Santos', doctor: 'Dr. Liza Reyes', date: today, time: '09:00', reason: 'Routine checkup', status: 'Scheduled', notes: '' },
    { id: 2, patient: 'Juan dela Cruz', doctor: 'Dr. Ramon Santos', date: today, time: '10:30', reason: 'Fever and cough', status: 'Completed', notes: 'Prescribed Amoxicillin' },
    { id: 3, patient: 'Ana Reyes', doctor: 'Dr. Ramon Santos', date: today, time: '14:00', reason: 'Diabetes monitoring', status: 'Scheduled', notes: '' },
  ]);

  DB.set('records', [
    { id: 1, patient: 'Maria Santos', doctor: 'Dr. Liza Reyes', diagnosis: 'Hypertension Stage 1', prescription: 'Amlodipine 5mg daily', notes: 'Monitor BP weekly', date: today, type: 'Consultation' },
    { id: 2, patient: 'Juan dela Cruz', doctor: 'Dr. Ramon Santos', diagnosis: 'Acute Upper Respiratory Infection', prescription: 'Amoxicillin 500mg TID x 7 days, Paracetamol PRN', notes: 'Rest and hydration', date: today, type: 'Consultation' },
  ]);

  DB.set('billing', [
    { id: 1, patient: 'Maria Santos', service: 'Consultation – Cardiology', amount: 1500, date: today, status: 'Paid', method: 'Cash' },
    { id: 2, patient: 'Juan dela Cruz', service: 'Consultation + Medications', amount: 850, date: today, status: 'Paid', method: 'GCash' },
    { id: 3, patient: 'Ana Reyes', service: 'Diabetes Monitoring Package', amount: 2200, date: today, status: 'Pending', method: 'PhilHealth' },
  ]);
}
