...
function seedData() {
  ...
  DB.set("patients", [
    {
      ...
      status: "Active",
      emergency: "Jose Santos – 09171234568",
    },
    {
      id: 2,
      name: "Juan dela Cruz",
      ...
      history: "None",
      status: "Active",
      emergency: "Ana dela Cruz – 09281234568",
    },
    {
      id: 3,
      name: "Ana Reyes",
      ...
      status: "Critical",
      emergency: "Carlos Reyes – 09451234568",
    },
    {
      id: 4,
      name: "Pedro Garcia",
      ...
      history: "Asthma",
      status: "Active",
      emergency: "Luz Garcia – 09561234568",
    },
  ]);
  ...
  DB.set("billing", [
    ...
    },
    {
      id: 2,
      patient: "Juan dela Cruz",
      service: "Consultation + Medications",
      amount: 850,
      date: today,
      status: "Paid",
      method: "GCash",
...
function openModal(type, id = null) {
  ...
  if (id !== null) {
    ...
    ["d-name", "d-phone", "d-email", "d-license"].forEach((id) => {
      const el = document.getElementById(id);
      if (el) el.value = "";
    });
    ["a-reason", "a-notes"].forEach((id) => {
      const el = document.getElementById(id);
      if (el) el.value = "";
    });
    ...
    ["b-service"].forEach((id) => {
      const el = document.getElementById(id);
      if (el) el.value = "";
    });
    const bamt = document.getElementById("b-amount");
    if (bamt) bamt.value = "";
